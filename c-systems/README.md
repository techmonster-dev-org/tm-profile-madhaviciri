...
**madhaviciri** · [← Back to profile](../README.md) · Updated 2026-08-26
...
|---|---|---|---|---|
| Write your first C program, trace the four-stage gcc compilation pipeline (preprocess/compile/assemble/link), and understand why C produces tiny, fast native binaries. | ⬜ Not started | — | — | — |
...
| Master C's arithmetic, comparison, logical, and bitwise operators, understand operator precedence traps, and implement the set/test/clear/toggle bit-manipulation patterns used in every device driver and systems library. | ⬜ Not started | ⚠️ Unverified | 2026-08-26 | [→](https://github.com/techmonster-dev-org/tm-student-madhaviciri-c-systems/issues/2) |
| Master C's if/else, switch with fallthrough, all three loop forms, break/continue, and the kernel-style goto cleanup ladder — the control flow patterns found in the Linux kernel, git, nginx, and SQLite. | ⬜ Not started | — | — | — |
...
| Explore C's fundamental types, use sizeof and <limits.h> to inspect platform sizes and bounds, use <stdint.h> fixed-width types, and understand why signed overflow is undefined behavior while unsigned wraparound is not. | ⬜ Not started | ❌ Failed | 2026-08-26 | [→](https://github.com/techmonster-dev-org/tm-student-madhaviciri-c-systems/issues/1) |
