...
| Declare C++'s fundamental types (int, double, char, bool), measure their byte sizes with sizeof, explore ranges with <limits>, and use auto deduction — grounding static typing in the powers-of-two and overflow reasoning from math-foundations. | ⬜ Not started | ⚠️ Unverified | 2026-08-26 | [→](https://github.com/techmonster-dev-org/tm-student-madhaviciri-cpp-from-zero/issues/2) |
...
| Install a C++ compiler, write/compile/run a minimal program, and understand the compile-link-execute pipeline and how it differs from interpreted languages — building toolchain literacy, not just a hello world. | ⬜ Not started | ❌ Failed | 2026-08-26 | [→](https://github.com/techmonster-dev-org/tm-student-madhaviciri-cpp-from-zero/issues/1) |
