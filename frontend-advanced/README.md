...
| Create an axios instance with interceptors, error handling, and base URL configuration | ⬜ Not started | ❌ Failed | 2026-06-11 | — |
| Create loading skeletons, spinners, and loading UI components | ⬜ Not started | — | — | — |
| Set up multi-environment configuration with API endpoints and environment variables | ⬜ Not started | ❌ Failed | 2026-06-11 | — |
| Build reusable layouts with header, footer, sidebar, and nested layouts | ⬜ Not started | ❌ Failed | 2026-06-11 | — |
| Configure TanStack Query (React Query) with persistence and devtools for efficient data fetching | ⬜ Not started | ⚠️ Unverified | 2026-06-11 | — |
| Create a Next.js project with TypeScript, Tailwind CSS, and understand the App Router structure | ⬜ Not started | ❌ Failed | 2026-06-11 | — |
| Build toast notification system for success, error, and info messages | ⬜ Not started | ❌ Failed | 2026-06-11 | — |
